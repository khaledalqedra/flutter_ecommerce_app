...
class ChooselocationCubit extends Cubit<ChooselocationState> {
  ...
  void selectLocation(String id) {
    ...
    final choosenLocation = dummyLocations.firstWhere((location) => location.id == selectedLocationId);
    emit(LocationChosen(choosenLocation));
  }
  ...
  void confirmAddress() {
    ...
    Future.delayed(const Duration(seconds: 1), () {
      ...
      var previousAddress = dummyLocations
      .firstWhere((location) => location.isChosen == true,
